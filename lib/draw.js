...
var Draw = function Draw(){
  ...
  document.getElementById('high_score').innerHTML = localStorage.getItem('points') || 0
      ...
      switch (game.status) {
        ...
        case "lost":
          ...
          if(game.points > highScore) {
            ...
            //var initials = what the form sends back
            localStorage.setItem('points', game.points);
            //localStorage.setItem('initials', initials);
            // how do we concatanate????
            // document.getElementById('high_score').innerHTML = initials game.points
            document.getElementById('high_score').innerHTML = game.points
            debugger
          }
          break;
        case "newGame":
